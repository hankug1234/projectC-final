...
def load_model(model_name, pretrain=True, require_grad=True):
    print('==> Building modelCollection..')
...
def model_info(model):  # Plots a line-by-line description of a PyTorch modelCollection
...
def test(net, criterion, batch_size):
    ...
    testset = torchvision.datasets.ImageFolder(root='C:/Users/ygl/Desktop/pmg/master/bird/test',
